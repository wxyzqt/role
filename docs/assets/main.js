...
window.translations = {
  copy: "复制",
  copied: "已复制！",
  normally_hidden: "由于您的过滤器设置，该成员已被隐藏。",
  hierarchy_expand: "展开",
  hierarchy_collapse: "折叠",
  folder: "文件夹",
  search_index_not_available: "搜索索引不可用",
  search_no_results_found_for_0: "找不到包含 {0} 的结果",
  kind_1: "项目",
  kind_2: "模块",
  kind_4: "命名空间",
  kind_8: "枚举",
  ...
  kind_131072: "类型参数",
  kind_262144: "访问器",
  kind_524288: "Getter 签名",
  kind_1048576: "Setter 签名",
  kind_2097152: "类型别名",
  kind_4194304: "参考",
  kind_8388608: "文档",
};
